...
const IndexPage = () => (
  <Layout pageInfo={{ pageName: "index" }}>
    <Seo title="Equoo Game - Conquer Anxiety with eQuoo" keywords={[`equoo`, `mental health`, `mental health game`]} />
    ...
    <Row className="my-3 bg-full" style={{paddingLeft: '0', marginLeft: '0'}}>
      ...
      <Row className="justify-content-center my-1 bg-white" style={{paddingLeft: '0', marginLeft: '0'}}>
        <Col md="3">
      ...
      <Row className="justify-content-center my-1 bg-full">
        <Col md="6" offset="2">
      ...
      <Row className="justify-content-center bg-white mb-1">
      <Col md="5">
